    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <div class="col-12">
                        <h2 class="section__title">{{ __('pages.search_title') }}</h2>
                        <p class="section__text">{!! __('pages.search_desc', ['query' => request()->search]) !!}</p>
                    </div>
                </div>
                <div class="row row--grid">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="card card--big">
                            <a href="{{ route('view.watch-anime', ['slug' => $anime['id']]) }}" class="card__cover">
