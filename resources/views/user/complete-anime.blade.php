        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="section__title">{{ __('pages.complete_title') }}</h2>
                            <p class="section__text">{!! __('pages.complete_desc') !!}</p>
                        </div>
                    </div>
                        ...
                        @foreach ($anime_list as $anime)
                            <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                                <div class="card">
                                    ...
                                    <h3 class="card__title"><a href="details.html">{{ $anime['title'] }}</a></h3>
                                    <ul class="card__list">
                                        <li>{{ $anime['episode'] }}</li>
                                        <li>{{ $anime['uploaded_on'] }}</li>
                                    </ul>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="col-12">
                    <div class="catalog__paginator-wrap">
                        ...
                        <ul class="catalog__paginator">
                            <li>
                                <a href="{{ route('view.complete-anime', ['page' => $page == 1 ? 1 : $page - 1]) }}">
                            ...
                            @foreach ($paginates as $pagination)
                                @if (is_int(intval($pagination)))
                                    <li class="@if ($pagination == $page) active @endif"><a
                                            href="{{ route('view.complete-anime', ['page' => $pagination]) }}">{{ $pagination }}</a>
                                    </li>
                                @else
                                @break
                            @endif
                        ...
                        @if ($page != end($paginates))
                            <li>
                                <a href="{{ route('view.complete-anime', ['page' => $page + 1]) }}">
                                    <svg width="14" height="11" viewBox="0 0 14 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
