        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-6">
                    <h1 class="section__title section__title--head">{{ __('pages.contact_title') }}</h1>
                </div>

                <div class="col-12 col-xl-6">
                    <ul class="breadcrumb">
                        <li class="breadcrumb__item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb__item breadcrumb__item--active">{{ __('pages.contact_title') }}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 col-xl-8">
                    <form action="{{ route('post.mail.contact') }}" method="POST"
                ...
                <div class="col-12 col-lg-5 col-xl-4">
                    ...
                    <p class="section__text">{!! __('pages.contact_desc') !!}</p>
                    <ul class="contacts__list">
                        <li><a href="tel:+18092345678">{{ __('pages.support_phone') }}</a></li>
                        <li><a href="mailto:{{ __('pages.support_mail') }}">{{ __('pages.support_mail') }}</a></li>
                    </ul>
                    <div class="contacts__social">
                        ...
                        <a href="https://www.instagram.com/volkov_des1gn/" target="_blank"><svg width="30"
                                ...
                                <path
                                    d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z"
                                    fill="white" />
                                <mask id="mask01" maskUnits="userSpaceOnUse" x="0" y="0" width="30"
                                    height="30">
